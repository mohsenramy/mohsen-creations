...
describe('LRUCache set', () => {
  it('should set record in cache', async () => {
    // it.skip('should set record in cache', async () => {
    const lruCache = createLRUCacheProvider<string>({
      itemLimit: 10,
      ttl: 50000,
    });
  ...
  it('should overwrite previous record in cache with the same key', async () => {
    // it.skip('should overwrite previous record in cache with the same key', async () => {
    const lruCache = createLRUCacheProvider<string>({
      itemLimit: 10,
      ttl: 50000,
    });
  ...
  it('should overwrite previous record in cache with the same key and extend the TTL', async () => {
    // it.skip('should overwrite previous record in cache with the same key and extend the TTL', async () => {
    const lruCache = createLRUCacheProvider<string>({
      itemLimit: 10,
      ttl: 500,
    });
  ...
  it('should set record while evicting least recently used', async () => {
    // it.skip('should set record while evicting least recently used', async () => {
    const lruCache = createLRUCacheProvider<string>({
      itemLimit: 2,
      ttl: 50000,
    });
  ...
  it('should take `get` operation into account while evicting least recently used', async () => {
    // it.skip('should take `get` operation into account while evicting least recently used', async () => {
    const lruCache = createLRUCacheProvider<string>({
      itemLimit: 3,
      ttl: 50000,
    });
  ...
  it('should take `has` operation into account while evicting least recently used', async () => {
    // it.skip('should take `has` operation into account while evicting least recently used', async () => {
    const lruCache = createLRUCacheProvider<string>({
      itemLimit: 3,
      ttl: 50000,
    });
  ...
  it('should take `set` operation into account while evicting least recently used', async () => {
    // it.skip('should take `set` operation into account while evicting least recently used', async () => {
    const lruCache = createLRUCacheProvider<string>({
      itemLimit: 3,
      ttl: 50000,
    });
  ...
  it('should set record without evicting least recently used while TTL is reached', async () => {
    // it.skip('should set record without evicting least recently used while TTL is reached', async () => {
